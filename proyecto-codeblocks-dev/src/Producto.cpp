...
Producto::Producto(int ID,int categoria, int idMarca, std::string modelo, std::string descripcion, long double precioVenta, int stock, bool activo)
{
    _ID = ID;
...
void Producto::setPrecio(long double precioVenta)
{
    _precioVenta = precioVenta;
}
...
long double Producto::getPrecio()
{
    return _precioVenta;
}
